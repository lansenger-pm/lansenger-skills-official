...
| `lansenger-messaging` | 4 messaging channels, message type matrix, @mention rules, CLI method selection |
| `lansenger-chat` | Fetch chat list (private + group) and pull messages from conversations |
| `lansenger-group` | Create groups, fetch info/members, list groups, check membership, update settings |
...
| `lansenger-calendar` | Primary calendar, schedule CRUD, attendee management |
